...
void contour::get_outline(std::vector<p2t::Point*> &polyline_out) const {
...
void contour::get_extrude(buffer_data &data_out) const {
...
contour::windingtype contour::get_winding() {
...
void contour::set_winding_clockwise() {
...
void contour::set_winding_counterclockwise() {
